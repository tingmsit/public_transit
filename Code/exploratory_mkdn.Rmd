---
title: "Rideshare Exploratory Analysis"
author: "Team 16"
...
Download the "RideAustin_Weather" csv file from the link location and save that under "Data" folder. The code file is to be downloaded into "Code" folder. 
...
Similiar exploration will need to be done on bus ride data set, and run correlation test with rideshare data to identify potential relationships
